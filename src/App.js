...
import './App.css';
import currency_input from '../src/components/currency_input';
...
class CurrencyConverter extends react.Component {
  constructor(props) {
    ...
    this.handleUsdChange = this.handleEuroChange.bind(this);
  }
...
const root = React.DOM.createRoot(container);
root.render(<CurrentcyConverter />)
=======
